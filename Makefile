...
ifneq (,$(findstring MINGW,$(uname_S)))
	...
	NO_PYTHON = YesPlease
	BLK_SHA1 = YesPlease
	COMPAT_CFLAGS += -D__USE_MINGW_ACCESS -DNOGDI -DNO_MMAP -DNO_REGEX -DNO_SETENV -Igit/compat -Igit/compat/fnmatch -Igit/compat/win32 -Igit/compat/regex
